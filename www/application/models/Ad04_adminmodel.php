<?php
class Ad04_adminmodel extends CI_Model {
    ...
    public function insert_login() {
        ...
        $result = $this->db->insert('ad04_admin', $array);
    ...
    public function loginData() {
        // $_POST['id'] = 'ad04';
        // $_POST['pass'] = 'admin';
        $sql="SELECT admin_idx, admin_id, admin_pass FROM ad04_admin WHERE admin_id = ?";
        $array = array($_POST['id']);
        $data = $this->db->query($sql, $array)->row();

        if (password_verify($_POST['pass'] ,$data->admin_pass) ) {

            setcookie('ad04_id', $_POST['id'], time() + 3600);
            setcookie('ad04_idx', $data->admin_idx, time() + 3600);
...
//slide -----------------------------------------------------------------
    public function slideListData($page = 1) {
        ...
        $sql="SELECT slide_idx, @rownum:=@rownum+1 num, slide_name, slide_image, slide_link, slide_date
                FROM ad04_slide, (SELECT @rownum:=0) TMP
    ...
    public function slideinsertData() {
        ...
        $sql="SELECT slide_idxs FROM ad04_slide order by slide_idxs DESC LIMIT 1";
    ...
    public function slideIdxsUpdate() {
        ...
        for($i=0; $i<count($idxs); $i++) {
            $sql= "UPDATE ad04_slide SET slide_idxs = ? WHERE slide_idx = ?";
    ...
    public function slidedel($idx) {
        $array = array($idx);
        $sql= "DELETE FROM ad04_slide WHERE slide_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return'=>$result);
    }

    public function slideCount() {
        $sql="SELECT COUNT(*) count  FROM ad04_slide";
...
//-------------------------------------------------------------------------
    ...
    public function categoryListData($page = 1) {
        ...
        $sql="SELECT category_idx, @rownum:=@rownum+1 num, category_name, category_image, category_date
                FROM ad04_category, (SELECT @rownum:=0) TMP
    ...
    public function categoryData($idx) {
        ...
        $sql="SELECT category_idx, category_name, category_image
            FROM ad04_category WHERE category_idx = ?";
        return $this->db->query($sql, $array)->row();
    }

    public function categoryUpdate() {
        $array = array($_POST['name'], $_POST['image'], $_POST['idx']);
        $sql= "UPDATE ad04_category SET category_name = ?, category_image = ?
                WHERE category_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return'=>$result);
    }
    ...
    public function categorydel($idx) {
        $array = array($idx);
        $sql= "DELETE FROM ad04_category WHERE category_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return'=>$result);
    }
        ...
        //카테고리2
        public function category2ListData($page = 1) {
            $table = "ad04_category2";
            $limit=10;
            $offset=$limit*($page-1);
            $sql="SELECT category_idx2, @rownum:=@rownum+1 num, category_name, category_image, category_date
                    FROM ad04_category2, (SELECT @rownum:=0) TMP
                    ORDER BY category_idx2 DESC ";
            // limit {$limit} offset {$offset}
            $result = $this->db->query($sql)->result();
        ...
        public function category2insertData() {
            $table = "ad04_category2";
            foreach($_POST as $key => $value ){
                $key = 'category_'.$key;
                $array[$key] = $value;
        ...
        public function category2Data($idx) {
            $array = array($idx);
            $sql="SELECT category_idx2, category_name, category_image
                FROM ad04_category2 WHERE category_idx2 = ?";
            return $this->db->query($sql, $array)->row();
        }
    
        public function category2Update() {
            $array = array($_POST['name'], $_POST['image'], $_POST['idx']);
            $sql= "UPDATE ad04_category2 SET category_name = ?, category_image = ?
                    WHERE category_idx2 = ?";
            $result = $this->db->query($sql, $array);
            return array('return'=>$result);
        }
    
        public function category2del($idx) {
            $array = array($idx);
            $sql= "DELETE FROM ad04_category2 WHERE category_idx2 = ?";
            $result = $this->db->query($sql, $array);
            return array('return'=>$result);
        }
    ...
    public function faqinsertData() {
        $table = "ad04_faq";
        $sql="SELECT faq_idxs FROM ad04_faq order by faq_idxs DESC LIMIT 1";
    ...
    public function faqListData($page = 1) {
        ...
        $sql="SELECT faq_idx, @rownum:=@rownum+1 num, faq_question, faq_answer
                FROM ad04_faq, (SELECT @rownum:=0) TMP
    ...
    public function faqData($idx) {
        ...
        $sql="SELECT faq_idx, faq_question, faq_answer
            FROM ad04_faq WHERE faq_idx = ?";
        return $this->db->query($sql, $array)->row();
    }

    public function faqUpdate() {
        $array = array($_POST['question'], $_POST['answer'], $_POST['idx']);
        $sql= "UPDATE ad04_faq SET faq_question = ?, faq_answer = ?
                WHERE faq_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return'=>$result);
    }
    ...
    public function faqIdxsUpdate() {
        ...
        $table = "ad04_faq";
        for($i=0; $i<count($idxs); $i++) {
            $sql= "UPDATE ad04_faq SET faq_idxs = ? WHERE faq_idx = ?";
            $array = array($idxs[$i], $idx[$i]);
            $result = $this->db->query($sql, $array);
        }
        return array('return'=>$result);
    ...
    public function faqdel($idx) {
        $array = array($idx);
        $sql= "DELETE FROM ad04_faq WHERE faq_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return'=>$result);
    }

    public function faqCount() {
        $sql="SELECT COUNT(*) count  FROM ad04_faq";
        return $this->db->query($sql, $array)->row()->count;
    }

    //상품 관리
    public function productinsertData() {
        $producttable = "ad04_product";
        $insuretable = "ad04_insure";

        $sql="SELECT product_idxs FROM ad04_product order by product_idxs DESC LIMIT 1";
        $product_idxs = $this->db->query($sql)->row()->product_idxs + 1;

        $product['category_idx'] = $_POST['category_idx'];

        $product['category_idx2'] = $_POST['category_idx2'];
    ...
    public function categorySelectData() {
        $sql="SELECT category_idx, category_name FROM ad04_category";
        return $this->db->query($sql)->result();
    }
    public function category2SelectData() {
        $sql="SELECT category_idx2, category_name FROM ad04_category2";
        return $this->db->query($sql)->result();
    }
    ...
    public function productListData($page = 1) {
        ...
        SELECT product_idx
            , category_name, insure_name, insure_call,
                ...
                product_show shows
                 FROM ad04_product
        				JOIN ad04_insure USING(product_idx)
        				LEFT JOIN ad04_category
        				USING(category_idx)  JOIN ( SELECT @rownum := 0) R
          ) A ORDER BY product_idxs DESC
              limit {$limit} offset {$offset}";
        $result = $this->db->query($sql)->result();

        $sql="SELECT COUNT(*) count FROM ad04_product
        JOIN ad04_insure USING(product_idx) JOIN ad04_category
        USING(category_idx)";
        $count = $this->db->query($sql)->row();
    ...
    public function productData($idx) {
        $sql="SELECT product_idx, category_idx,category_idx2, insure_name, insure_call,
              insure_company, insure_logo, insure_video, product_company,
              product_logo, product_slide, product_name, product_hashtag,
              product_time, product_slidevideo, insure_text,insure_text2,
              product_gettext, product_thumb
              FROM ad04_product JOIN ad04_insure
    ...
    public function productIdxUpdate() {
        ...
        $table = "ad04_product";
        for($i=0; $i<count($idxs); $i++) {
            $sql= "UPDATE ad04_product SET product_idxs = ? WHERE product_idx = ?";
            $array = array($idxs[$i], $idx[$i]);
            $result = $this->db->query($sql, $array);
        }
        return array('return'=>$result);
    ...
    public function productdel($idx) {
        $array = array($idx);
        $sql= "DELETE FROM ad04_product WHERE product_idx = ?";
        $result = $this->db->query($sql, $array);
        $sql= "DELETE FROM ad04_insure WHERE product_idx = ?";
    ...
    public function productShow() {
        ...
        $sql= "UPDATE ad04_product SET product_show = ?
          WHERE product_idx = ?";
...
//소식---------------------------------------------------------
    public function newsListData($page = 1) {
        ...
        $sql="SELECT news_idx, @rownum:=@rownum+1 num, news_title, news_thumb image,
                ...
                FROM ad04_news, (SELECT @rownum:=0) TMP
                ORDER BY news_idxs DESC
                limit {$limit} offset {$offset}";
        // limit {$limit} offset {$offset}
        $result = $this->db->query($sql)->result();

        $sql="SELECT COUNT(*) count FROM ad04_news";
        $count = $this->db->query($sql)->row();
    ...
    public function newsInsertData() {
        $sql = "INSERT INTO ad04_news (news_title, news_content, news_thumb, news_date) VALUES (?, ?, ?, now())";
        $array = array($_POST['news_title'],$_POST['news_content'],$_POST['news_thumb']);
        $result = $this->db->query($sql,$array);
        $insert_id = $this->db->insert_id();

        $sql="SELECT news_idxs FROM ad04_news order by news_idxs DESC LIMIT 1";
        $news_idxs = $this->db->query($sql)->row()->news_idxs + 1;

        $sql= "UPDATE ad04_news SET news_idxs = ? WHERE news_idx = ?";
    ...
    public function newsShow() {
        ...
        $sql= "UPDATE ad04_news SET news_show = ?
        WHERE news_idx = ?";
        $array = array($show, $_POST['idx']);
        $result = $this->db->query($sql, $array);
        return array('return'=>$result);
    ...
    public function newsUpdate() {
        ...
        $sql= "UPDATE ad04_news SET news_title = ?, news_content = ?, news_thumb = ?
              WHERE news_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return'=>$result);
    }
    ...
    public function newsDel($idx) {
        $array = array($idx);
        $sql= "DELETE FROM ad04_news WHERE news_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return'=>$result);
    }
    ...
    public function yutubelistData($page = 1) {
        ...
        $sql="SELECT yutube_idx, @rownum:=@rownum+1 num, yutube_link, yutube_date
                FROM ad04_yutube, (SELECT @rownum:=0) TMP
    ...
    public function yutubeinsertData() {
        ...
        $sql="SELECT yutube_idxs FROM ad04_yutube order by yutube_idxs DESC LIMIT 1";
    ...
    public function yutubeData($idx) {
        ...
        $sql="SELECT yutube_idx, yutube_name, yutube_image, yutube_link
            FROM ad04_yutube WHERE yutube_idx = ?";
        return $this->db->query($sql, $array)->row();
    }

    public function yutubeUpdate() {
        $array = array($_POST['name'], $_POST['image'], $_POST['link'], $_POST['idx']);
        $sql= "UPDATE ad04_yutube SET yutube_name = ?, yutube_image = ?,
    ...
    public function yutubeIdxsUpdate() {
        ...
        $table = "ad04_yutube";
        for($i=0; $i<count($idxs); $i++) {
            $sql= "UPDATE ad04_yutube SET yutube_idxs = ? WHERE yutube_idx = ?";
            $array = array($idxs[$i], $idx[$i]);
            $result = $this->db->query($sql, $array);
        }
        return array('return'=>$result);
    ...
    public function yutubedel($idx) {
        $array = array($idx);
        $sql= "DELETE FROM ad04_yutube WHERE yutube_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return'=>$result);
    }

    public function yutubeCount() {
        $sql="SELECT COUNT(*) count  FROM ad04_yutube";
        return $this->db->query($sql, $array)->row()->count;
    }
}
