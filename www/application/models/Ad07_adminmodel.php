<?php
class Ad07_adminmodel extends CI_Model
{
    ...
    public function insert_login()
    {
        ...
        $result = $this->db->insert('ad07_admin', $array);
    ...
    public function loginData()
    {
        ...
        // $_POST['id'] = 'ad07';
        // $_POST['pass'] = 'admin';
        $sql = "SELECT admin_idx, admin_id, admin_pass FROM ad07_admin WHERE admin_id = ?";
        $array = array($_POST['id']);
        $data = $this->db->query($sql, $array)->row();

        if (password_verify($_POST['pass'], $data->admin_pass)) {

            setcookie('ad07_id', $_POST['id'], time() + 3600);
            setcookie('ad07_idx', $data->admin_idx, time() + 3600);
    ...
    public function slideListData($page = 1)
    {
        ...
        $sql = "SELECT slide_idx, @rownum:=@rownum+1 num, slide_name, slide_image, slide_link, slide_date
                FROM ad07_slide, (SELECT @rownum:=0) TMP
    ...
    public function slideinsertData()
    {
        ...
        $sql = "SELECT slide_idxs FROM ad07_slide order by slide_idxs DESC LIMIT 1";
    ...
    public function slideData($idx)
    {
        ...
        $sql = "SELECT slide_idx, slide_name, slide_image, slide_link
            FROM ad07_slide WHERE slide_idx = ?";
    ...
    public function slideUpdate()
    {
        ...
        $sql = "UPDATE ad07_slide SET slide_name = ?, slide_image = ?,
    ...
    public function slideIdxsUpdate()
    {
        ...
        for ($i = 0; $i < count($idxs); $i++) {
            $sql = "UPDATE ad07_slide SET slide_idxs = ? WHERE slide_idx = ?";
    ...
    {
        $array = array($idx);
        $sql = "DELETE FROM ad07_slide WHERE slide_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    {
        $sql = "SELECT COUNT(*) count  FROM ad07_slide";
        return $this->db->query($sql, $array)->row()->count;
            ...
            public function eventListData($page = 1) {
                ...
                $sql="SELECT event_idx, @rownum:=@rownum+1 num, event_name, event_image, event_link, event_date
                        FROM ad07_event, (SELECT @rownum:=0) TMP
            ...
            public function eventinsertData() {
                ...
                $sql="SELECT event_idxs FROM ad07_event order by event_idxs DESC LIMIT 1";
            ...
            public function eventData($idx) {
                ...
                $sql="SELECT event_idx, event_name, event_image, event_link
                    FROM ad07_event WHERE event_idx = ?";
                return $this->db->query($sql, $array)->row();
            }
        
            public function eventUpdate() {
                $array = array($_POST['name'], $_POST['image'], $_POST['link'], $_POST['idx']);
                $sql= "UPDATE ad07_event SET event_name = ?, event_image = ?,
            ...
            public function eventIdxsUpdate() {
                ...
                $table = "ad07_event";
                for($i=0; $i<count($idxs); $i++) {
                    $sql= "UPDATE ad07_event SET event_idxs = ? WHERE event_idx = ?";
                    $array = array($idxs[$i], $idx[$i]);
                    $result = $this->db->query($sql, $array);
                }
                return array('return'=>$result);
            ...
            public function eventdel($idx) {
                $array = array($idx);
                $sql= "DELETE FROM ad07_event WHERE event_idx = ?";
                $result = $this->db->query($sql, $array);
                return array('return'=>$result);
            }
        
            public function eventCount() {
                $sql="SELECT COUNT(*) count  FROM ad07_event";
                return $this->db->query($sql, $array)->row()->count;
            }
    ...
    public function categoryListData($page = 1)
    {
        ...
        $sql = "SELECT category_idx, @rownum:=@rownum+1 num, category_name, category_image, category_date
                FROM ad07_category, (SELECT @rownum:=0) TMP
    ...
    public function categoryData($idx)
    {
        ...
        $sql = "SELECT category_idx, category_name, category_image
            FROM ad07_category WHERE category_idx = ?";
        return $this->db->query($sql, $array)->row();
    }
    ...
    public function categoryUpdate()
    {
        ...
        $sql = "UPDATE ad07_category SET category_name = ?, category_image = ?
                WHERE category_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    {
        $array = array($idx);
        $sql = "DELETE FROM ad07_category WHERE category_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    {
        $table = "ad07_faq";
        $sql = "SELECT faq_idxs FROM ad07_faq order by faq_idxs DESC LIMIT 1";
    ...
    public function faqListData($page = 1)
    {
        ...
        $sql = "SELECT faq_idx, @rownum:=@rownum+1 num, faq_question, faq_answer
                FROM ad07_faq, (SELECT @rownum:=0) TMP
    ...
    public function faqUpdate()
    {
        ...
        $sql = "UPDATE ad07_faq SET faq_question = ?, faq_answer = ?
                WHERE faq_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    public function faqIdxsUpdate()
    {
        ...
        $table = "ad07_faq";
        for ($i = 0; $i < count($idxs); $i++) {
            $sql = "UPDATE ad07_faq SET faq_idxs = ? WHERE faq_idx = ?";
            $array = array($idxs[$i], $idx[$i]);
            $result = $this->db->query($sql, $array);
        }
        return array('return' => $result);
    ...
    {
        $array = array($idx);
        $sql = "DELETE FROM ad07_faq WHERE faq_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    {
        $sql = "SELECT COUNT(*) count  FROM ad07_faq";
        return $this->db->query($sql, $array)->row()->count;
    }
    ...
    {
        $producttable = "ad07_product";
        $insuretable = "ad07_insure";

        $sql = "SELECT product_idxs FROM ad07_product order by product_idxs DESC LIMIT 1";
    ...
    {
        $sql = "SELECT category_idx, category_name FROM ad07_category";
    ...
    public function productListData($page = 1)
    {
        ...
        SELECT product_idx
            , category_name, insure_name, insure_call,
                ...
                product_show shows
                 FROM ad07_product
        				JOIN ad07_insure USING(product_idx)
        				LEFT JOIN ad07_category
        				USING(category_idx)  JOIN ( SELECT @rownum := 0) R
          ) A ORDER BY product_idxs DESC
              limit {$limit} offset {$offset}";
        $result = $this->db->query($sql)->result();

        $sql = "SELECT COUNT(*) count FROM ad07_product
        JOIN ad07_insure USING(product_idx) JOIN ad07_category
        USING(category_idx)";
        $count = $this->db->query($sql)->row();
    ...
    public function productData($idx)
    {
        $sql = "SELECT product_idx, category_idx, insure_name, insure_call,
              ...
              FROM ad07_product JOIN ad07_insure
    ...
    public function productIdxUpdate()
    {
        ...
        $table = "ad07_product";
        for ($i = 0; $i < count($idxs); $i++) {
            $sql = "UPDATE ad07_product SET product_idxs = ? WHERE product_idx = ?";
            $array = array($idxs[$i], $idx[$i]);
            $result = $this->db->query($sql, $array);
        }
        return array('return' => $result);
    ...
    {
        $array = array($idx);
        $sql = "DELETE FROM ad07_product WHERE product_idx = ?";
        $result = $this->db->query($sql, $array);
        $sql = "DELETE FROM ad07_insure WHERE product_idx = ?";
    ...
    public function productShow()
    {
        ...
        $sql = "UPDATE ad07_product SET product_show = ?
          WHERE product_idx = ?";
    ...
    public function newsListData($page = 1)
    {
        ...
        $sql = "SELECT news_idx, @rownum:=@rownum+1 num, news_title, news_thumb image,
                ...
                FROM ad07_news, (SELECT @rownum:=0) TMP
                ORDER BY news_idxs DESC
                limit {$limit} offset {$offset}";
        // limit {$limit} offset {$offset}
        $result = $this->db->query($sql)->result();

        $sql = "SELECT COUNT(*) count FROM ad07_news";
        $count = $this->db->query($sql)->row();
    ...
    {
        $sql = "INSERT INTO ad07_news (news_title, news_content, news_thumb, news_date) VALUES (?, ?, ?, now())";
        $array = array($_POST['news_title'], $_POST['news_content'], $_POST['news_thumb']);
        $result = $this->db->query($sql, $array);
        $insert_id = $this->db->insert_id();

        $sql = "SELECT news_idxs FROM ad07_news order by news_idxs DESC LIMIT 1";
        $news_idxs = $this->db->query($sql)->row()->news_idxs + 1;

        $sql = "UPDATE ad07_news SET news_idxs = ? WHERE news_idx = ?";
    ...
    public function newsShow()
    {
        ...
        $sql = "UPDATE ad07_news SET news_show = ?
        WHERE news_idx = ?";
        $array = array($show, $_POST['idx']);
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    ...
    public function newsUpdate()
    {
        ...
        $sql = "UPDATE ad07_news SET news_title = ?, news_content = ?, news_thumb = ?
              WHERE news_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    {
        $array = array($idx);
        $sql = "DELETE FROM ad07_news WHERE news_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    public function yutubelistData($page = 1)
    {
        ...
        $sql = "SELECT yutube_idx, @rownum:=@rownum+1 num, yutube_link, yutube_date
                FROM ad07_yutube, (SELECT @rownum:=0) TMP
    ...
    public function yutubeinsertData()
    {
        ...
        $sql = "SELECT yutube_idxs FROM ad07_yutube order by yutube_idxs DESC LIMIT 1";
    ...
    public function yutubeData($idx)
    {
        ...
        $sql = "SELECT yutube_idx, yutube_name, yutube_image, yutube_link
            FROM ad07_yutube WHERE yutube_idx = ?";
        return $this->db->query($sql, $array)->row();
    }
    ...
    {
        $array = array($_POST['name'], $_POST['image'], $_POST['link'], $_POST['idx']);
        $sql = "UPDATE ad07_yutube SET yutube_name = ?, yutube_image = ?,
    ...
    public function yutubeIdxsUpdate()
    {
        ...
        $table = "ad07_yutube";
        for ($i = 0; $i < count($idxs); $i++) {
            $sql = "UPDATE ad07_yutube SET yutube_idxs = ? WHERE yutube_idx = ?";
            $array = array($idxs[$i], $idx[$i]);
            $result = $this->db->query($sql, $array);
        }
        return array('return' => $result);
    ...
    {
        $array = array($idx);
        $sql = "DELETE FROM ad07_yutube WHERE yutube_idx = ?";
        $result = $this->db->query($sql, $array);
        return array('return' => $result);
    }
    ...
    {
        $sql = "SELECT COUNT(*) count  FROM ad07_yutube";
        return $this->db->query($sql, $array)->row()->count;
    }
}
