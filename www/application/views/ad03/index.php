...
<body id="top">
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="custom-collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li>
							<a href="/ad03/about">콜겟TV란?</a>
						</li>
						<li>
							<a href="/ad03/faq">이용방법</a>
						</li>
						<!-- <li>
							<a href="/ad03/news/1">소식</a>
						</li>-->
						<li>
							<a href="/ad03/event">이벤트</a>
						</li>
						<li>
							<a href="/ad03/contactus">문의하기</a>
						</li>
					</ul>
				</div>
			</div><!-- Container_END -->
		...
		<div class="container">
			<div id="slider01" class="gallery-wrapper">
				<ul class="gallery-list web">
					...
					<li><a href="https://callget.co.kr/ad03/news_view/19"><img src="/assets/images/banner/event_vn2.png" alt="" /></a></li>
				</ul>
		...
		<div class="container">
			<div id="slider02" class="gallery-wrapper">
				<ul class="gallery-list web">
					...
					<li><a href="https://callget.co.kr/ad03/news_view/19"><img src="/assets/images/banner/event_vn_m2.png" alt="" /></a></li>
				</ul>
				<a class="btn-prev" href="#none">◀</a>
				<a class="btn-next" href="#none">▶</a>
				<div class="ctrl-box">
	...
	<section id="product" class="mb30">
		<div class="container">
			...
			<div class="category">
				<ul>
					<li class="ad03_cate_list active" data-number="0">
					...
					<? foreach ($category as $cate) : ?>
						<li class="ad03_cate_list" data-number="<?= $cate->category_idx ?>">
							<a href="javascript:void(0);">
	...
	<script src="/assets/js/ad03_callgetdev.js"></script>
