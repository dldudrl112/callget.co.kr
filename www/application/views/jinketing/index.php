...
<body id="top">
		...
		<div class="container">
			<div id="slider01" class="gallery-wrapper">
				<ul class="gallery-list web">
					...
					<li><a href="https://callget.co.kr/jinketing/news_view/9"><img src="/assets/images/banner/event_vn2.png" alt="" /></a></li>
				</ul>
		...
		<div class="container">
			<div id="slider02" class="gallery-wrapper">
				<ul class="gallery-list web">
					...
					<li><a href="https://callget.co.kr/jinketing/news_view/9"><img src="/assets/images/banner/event_vn_m2.png" alt="" /></a></li>
				</ul>
				<a class="btn-prev" href="#none">◀</a>
				<a class="btn-next" href="#none">▶</a>
				<div class="ctrl-box">
	...
	<section id="product" class="mb30">
		<div class="container">
			...
			<div class="category">
				<ul>
					<li class="jinketing_cate_list active" data-number="0">
					...
					<? foreach ($category as $cate) : ?>
						<li class="jinketing_cate_list" data-number="<?= $cate->category_idx ?>">
							<a href="javascript:void(0);">
	...
	<script src="/assets/js/jinketing_callgetdev.js"></script>
