...
<body>
    ...
    <section id="get_main3">
        ...
        <div class="get_area1" id="list">
            <button id="getcall" class="get_btn" data-idx="<?= $data->product_idx ?>">간편하게 전화로 상담 예약하기 <p style="font-size:10px; line-height: 0.5em;">(평균소요시간 30초)</p></button>
        </div>
        <div class="get_area_m" id="list">
            <button id="getcall" class="get_btn" ">간편하게 전화로 상담 예약하기 <p style=" font-size:10px; line-height: 0.5em;">(평균소요시간 30초)</p></button>
        </div>
    </section>
    ...
    <script src="/assets/js/main_callgetdev.js"></script>
