...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="custom-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a href="/tevent/about">콜겟TV란?</a>
                        </li>
                        <li>
                            <a href="/tevent/faq">이용방법</a>
                        </li>
                        <li>
                            <a href="/tevent/event">이벤트</a>
                        </li>
                        <!-- <li>
							<a href="/tevent/news/1">소식</a>
						</li> -->
                        <li>
                            <a href="/tevent/contactus">문의하기</a>
                        </li>
                    </ul>
                </div>
            </div><!-- Container_END -->
        ...
        <div class="container">
            <div class="row" style="margin:0px ;">
                <div style="padding: 10px 0%;">
                    <div class="get_area_m" id="list" style="position: inherit;    text-align: center;">
                        <button id="getcall" style="border-radius: 14px; border: 0px solid; padding: 6px 10px; background-color: #2970d6; color: #fff; width:100%" class="get_btn" >간편하게 전화로 상담 예약하기<p style=" font-size:10px; line-height: 0.5em;">(평균 소요시간 30초)</p></button>
                    </div>
                </div>
                <div class="info">
    ...
    <section id="get_product2" class="get_product_notice mb10">
        <div class="container box_padding">
            <div class="row">
    ...
    <section id="get_product2" class="g  product_content mb10">
        <div class="container box_padding">
            <div class="row">
                <div class="product_title">
                    <h2>이용방법 및 유의사항</h2><br>
                    <h3>꼭 읽어주세요!</h3>
                    <p>
                        본 영상은 리워드 영상입니다.<br>
                    ...
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-default">
                            ...
                            <div id="collapse0" class="panel-collapse collapse">
                                <div class="panel-body">
                                    메인 페이지에서 원하는 리워드/라이프 서비스를 선택하고, 상담을 완료하면
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapse1" class="panel-collapse collapse">
                                <div class="panel-body">
                                    네 맞습니다. 라이프 서비스 상담을 완료하면 가입 및 이용 여부와 관계없이
                                    리워드가 제공됩니다. 단, 각 파트너사가 정한 상담 완료 기준을 지켜야 정상
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapse2" class="panel-collapse collapse">
                                <div class="panel-body">
                                    동일한 라이프 서비스의 경우, 무료로 지급받을 수 있는 리워드는 1개로 제한
                                    되어 있습니다. 하지만, 라이프 서비스가 다른 경우에는 각각의 상담을 통해 리
                                    워드를 모두 지급받으실 수 있습니다.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapse3" class="panel-collapse collapse">
                                <div class="panel-body">
                                    전화 상담 예약 후 라이프 서비스 상담사와의 상담을 완료하시면 4주 ~ 8주 내
                                    에 고객님 주소로 배송됩니다.
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapse4" class="panel-collapse collapse">
                                <div class="panel-body">
                                    콜겟TV는 고객님의 어떠한 정보도 수집 및 보관하지 않습니다.

                                    라이프 서비스 상담을 진행하는 파트너사는 상담과 리워드 배송을 위해서만
                                    정보를 수집 및 이용합니다. 개인 정보 보관은 각 파트너사의 정책에 따라
                                    결정되며, 이는 전화 상담 시에 자세히 안내받을 수 있습니다.
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title panel-title-adjust">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse5">Q) 리워드 제품이 불량인 경우엔 어떻게 해야 하나요?</a>
                                </h4>
                            </div>
                            <div id="collapse5" class="panel-collapse collapse">
                                <div class="panel-body">
                                    모든 리워드는 콜겟TV와 제조/유통사가 정식으로 계약을 맺어 발송하는 상품
    ...
    <section id="get_main3">
        <div class="manual container" style="position: inherit; box-shadow:0px 0px 0px #fff; height:auto;padding:0px;">
        ...
        <!-- <div class="get_area1" style="position: inherit;">
            <button id="getcall" class="get_btn" onclick="location.href='tel:<?= $data->insure_call ?>'" data-idx="<?= $data->product_idx ?>">간편하게 전화로 상담 예약하기<p style="font-size:10px; line-height: 0.5em;">(평균 소요시간 30초)</p></button>
        </div> -->
        <div class="get_area_m2" id="list" style="position: inherit;">
    ...
    <script src="/assets/js/tevent_callgetdev.js"></script>
