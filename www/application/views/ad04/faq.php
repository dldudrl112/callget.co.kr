...
<body>
	...
	<section id="faq_3" class="faq mt50">
		<div class="container">
			<div class="row">
				<div class="img-faq">
					<img class="w" src="/assets/images/faq/top.jpg">
					<img class="m" src="/assets/images/faq/top_m.jpg">
				</div>
				<div class="video-faq">
				...
				<div class="img-faq">
					<img class="w" src="/assets/images/faq/bottom1.jpg">
					<a href="/ad04"><img class="w" src="/assets/images/faq/bottom1_button.jpg"></a>
					<img class="w" src="/assets/images/faq/bottom2.jpg">
					<img class="m" src="/assets/images/faq/bottom_m1.jpg">
					<a href="/ad04"><img class="m" src="/assets/images/faq/bottom_m1_button.jpg"></a>
					<img class="m" src="/assets/images/faq/bottom_m2.jpg">
				</div>
