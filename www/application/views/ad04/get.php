...
<body>
    ...
    <!-- Navigation -->
    <header>
        <nav class="navbar navbar-get navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="logo get">
                    <a href="/ad04">
                ...
                <div class="navbar-header">
                    <button type="button" class="return" onclick="location.href='/ad04';">
                ...
                <div class="get-nav">
                    <ul>
                        ...
                        <li>
                            <a href="/ad04/call/<?= $data->product_idx ?>">2 상품시청</a>
                        </li>
                        <li>
    ...
    <section id="get_main">
        ...
        <div id="myCarousel" class="carousel slide">
            ...
            <div class="get_area">
                <button class="get_btn" onclick="location.href='/ad04/call/<?= $data->product_idx ?>'" data-idx="<?= $data->product_idx ?>">GET 하러가기<p style="font-size:10px; line-height: 0.5em;">(365일,24시간 가능)</p></button>
            </div>
        </div>
        <!-- carousel end -->
