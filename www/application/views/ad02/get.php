                ...
                <div class="sub-navbar-get">
                    ...
                    <div class="get-nav">
                        <ul>
                            ...
                            <li>
                                <a href="/ad02/call/<?= $data->product_idx ?>">방송시청</a>
                            </li>
                            <li>
    ...
    <section id="get_main3">
        ...
        <div id="myCarousel" class="carousel slide">
            ...
            <div class="get_area" style="background-color: #2970d6;">
                <div class="container">
                    <div class="row">
                        <button class="get_btn" onclick="location.href='/ad02/call/<?= $data->product_idx ?>'" data-idx="<?= $data->product_idx ?>"><span>이 사은품 무료로 받기</span>
