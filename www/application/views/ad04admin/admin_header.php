        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="/ad04/admin/slideList" class="site_title"><img src="/assets/images/symbol.png" alt=""> <span>CALLGET</span></a>
                </div>
                        ...
                        <ul class="nav side-menu">
                            <li><a><i class="fa fa-edit"></i> Main <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="/ad04/admin/slideList">메인 슬라이드 관리</a></li>
                                    <li><a href="/ad04/admin/yutubeList">메인 유튜브영상 관리</a></li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-edit"></i> Product <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <!-- <li><a href="/ad04/admin/categoryList">카테고리 관리</a></li> -->
                                    <li><a href="/ad04/admin/productList">상품 관리</a></li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-edit"></i> FAQ <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="/ad04/admin/faqList">자주 묻는 질문</a></li>
                                </ul>
                            </li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            ...
                            <ul class="dropdown-menu dropdown-usermenu pull-right">
                                <li><a href="/ad04/admin/logout"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                            </ul>
                        </li>
                    </ul>
                    </li>
