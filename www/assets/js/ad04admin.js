$(document).ready(function(){
             ...
             $('body').on('click', '#slidego, #slideedit', function() {
                 ...
                 if(check) {
                     ...
                     if($(this).attr('id') == "slidego"){
                         var json = jsonreturn('/ad04/admin/slideinsertData',data);
                         if(json.return == true) {
                             alert("등록되었습니다");
                             location.href = "/ad04/admin/slideList";
                         }
                     }
                     else {
                         var json = jsonreturn('/ad04/admin/slideUpdate',data);
                         if(json.return == true) {
                             alert("수정되었습니다");
                             location.reload();
                         }
             ...
             $('body').on('click', '#yutubego, #yutubeedit', function() {
                 ...
                 if(check) {
                     ...
                     if($(this).attr('id') == "yutubego"){
                         var json = jsonreturn('/ad04/admin/yutubeinsertData',data);
                         if(json.return == true) {
                             alert("등록되었습니다");
                             location.href = "/ad04/admin/yutubeList";
                         }
                     }
                     else {
                         var json = jsonreturn('/ad04/admin/yutubeUpdate',data);
                         if(json.return == true) {
                             alert("수정되었습니다");
                             location.reload();
                         }
             ...
             $('body').on('click', '#categorygo, #categoryedit', function() {
                 ...
                 if(check) {
                     ...
                     if($(this).attr('id') == "categorygo"){
                         var json = jsonreturn('/ad04/admin/categoryinsertData',data);
                         if(json.return == true) {
                             alert("등록되었습니다");
                             location.href = "/ad04/admin/categoryList";
                         }
                     }
                     else {
                         var json = jsonreturn('/ad04/admin/categoryUpdate',data);
                         if(json.return == true) {
                             alert("수정되었습니다");
                             location.reload();
                         }
             ...
             $('body').on('click', '#faqgo, #faqedit', function() {
                 ...
                 if(check) {
                     ...
                     if($(this).attr('id') == "faqgo"){
                         var json = jsonreturn('/ad04/admin/faqinsertData',data);
                         if(json.return == true) {
                             alert("등록되었습니다");
                             location.href = "/ad04/admin/faqList";
                         }
                     }
                     else {
                         var json = jsonreturn('/ad04/admin/faqUpdate',data);
                         if(json.return == true) {
                             alert("수정되었습니다");
                             history.back();
                         }
             ...
             $('body').on('click', '#productgo, #productedit', function() {
                 ...
                 if(check) {
                     ...
                     if($(this).attr('id') == "productgo"){
                         var json = jsonreturn('/ad04/admin/productinsertData',data);
                         if(json.return == true) {
                             alert("등록되었습니다");
                             location.href = "/ad04/admin/productList";
                         }
                     }
                     else {
                         var json = jsonreturn('/ad04/admin/productUpdateData',data);
                         if(json.return == true) {
                             alert("수정되었습니다");
                             location.reload();
                         }
           ...
           $('body').on('click', '#newsgo, #newsedit', function() {
               ...
               if(check) {
                   ...
                   if($(this).attr('id') == "newsgo"){
                       var json = jsonreturn('/ad04/admin/newsInsertData',data);
                       if(json.return == true) {
                           alert("등록되었습니다");
                           location.href = "/ad04/admin/newsList";
                       }
                   }
                   else {
                       var json = jsonreturn('/ad04/admin/newsUpdate',data);
                       if(json.return == true) {
                           alert("수정되었습니다");
                           location.reload();
                       }
         ...
         this.login = function() {
           $('body').on('click', '#ns_logingo', function() {
               ...
               if(req) {
                   var form = $('form')[0];
                   var data = new FormData(form);
                   var json = jsonreturn('/ad04/admin/loginData',data);
                   if(json.return == true) {
                       location.href = '/ad04/admin/slideList';
                   }
                   else {
    ...
    //
		...
		// });
          ...
          //     location.href = '/ad04/admin/estimateView/'+idx;
          // });
