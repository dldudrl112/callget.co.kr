$(document).ready(function(){
             ...
             $('body').on('click', '#slidego, #slideedit', function() {
                 ...
                 if(check) {
                     ...
                     if($(this).attr('id') == "slidego"){
                         var json = jsonreturn('/ad07/admin/slideinsertData',data);
                         if(json.return == true) {
                             alert("등록되었습니다");
                             location.href = "/ad07/admin/slideList";
                         }
                     }
                     else {
                         var json = jsonreturn('/ad07/admin/slideUpdate',data);
                         if(json.return == true) {
                             alert("수정되었습니다");
                             location.reload();
                         }
            ...
            $('body').on('click', '#eventgo, #eventedit', function() {
                ...
                if(check) {
                    ...
                    if($(this).attr('id') == "eventgo"){
                        var json = jsonreturn('/ad07/admin/eventinsertData',data);
                        if(json.return == true) {
                            alert("등록되었습니다");
                            location.href = "/ad07/admin/eventList";
                        }
                    }
                    else {
                        var json = jsonreturn('/ad07/admin/eventUpdate',data);
                        if(json.return == true) {
                            alert("수정되었습니다");
                            location.reload();
                        }
             ...
             $('body').on('click', '#yutubego, #yutubeedit', function() {
                 ...
                 if(check) {
                     ...
                     if($(this).attr('id') == "yutubego"){
                         var json = jsonreturn('/ad07/admin/yutubeinsertData',data);
                         if(json.return == true) {
                             alert("등록되었습니다");
                             location.href = "/ad07/admin/yutubeList";
                         }
                     }
                     else {
                         var json = jsonreturn('/ad07/admin/yutubeUpdate',data);
                         if(json.return == true) {
                             alert("수정되었습니다");
                             location.reload();
                         }
             ...
             $('body').on('click', '#categorygo, #categoryedit', function() {
                 ...
                 if(check) {
                     ...
                     if($(this).attr('id') == "categorygo"){
                         var json = jsonreturn('/ad07/admin/categoryinsertData',data);
                         if(json.return == true) {
                             alert("등록되었습니다");
                             location.href = "/ad07/admin/categoryList";
                         }
                     }
                     else {
                         var json = jsonreturn('/ad07/admin/categoryUpdate',data);
                         if(json.return == true) {
                             alert("수정되었습니다");
                             location.reload();
                         }
             ...
             $('body').on('click', '#faqgo, #faqedit', function() {
                 ...
                 if(check) {
                     ...
                     if($(this).attr('id') == "faqgo"){
                         var json = jsonreturn('/ad07/admin/faqinsertData',data);
                         if(json.return == true) {
                             alert("등록되었습니다");
                             location.href = "/ad07/admin/faqList";
                         }
                     }
                     else {
                         var json = jsonreturn('/ad07/admin/faqUpdate',data);
                         if(json.return == true) {
                             alert("수정되었습니다");
                             history.back();
                         }
             ...
             $('body').on('click', '#productgo, #productedit', function() {
                 ...
                 if(check) {
                     ...
                     if($(this).attr('id') == "productgo"){
                         var json = jsonreturn('/ad07/admin/productinsertData',data);
                         if(json.return == true) {
                             alert("등록되었습니다");
                             location.href = "/ad07/admin/productList";
                         }
                     }
                     else {
                         var json = jsonreturn('/ad07/admin/productUpdateData',data);
                         if(json.return == true) {
                             alert("수정되었습니다");
                             location.reload();
                         }
           ...
           $('body').on('click', '#newsgo, #newsedit', function() {
               ...
               if(check) {
                   ...
                   if($(this).attr('id') == "newsgo"){
                       var json = jsonreturn('/ad07/admin/newsInsertData',data);
                       if(json.return == true) {
                           alert("등록되었습니다");
                           location.href = "/ad07/admin/newsList";
                       }
                   }
                   else {
                       var json = jsonreturn('/ad07/admin/newsUpdate',data);
                       if(json.return == true) {
                           alert("수정되었습니다");
                           location.reload();
                       }
         ...
         this.login = function() {
           $('body').on('click', '#ns_logingo', function() {
               ...
               if(req) {
                   var form = $('form')[0];
                   var data = new FormData(form);
                   var json = jsonreturn('/ad07/admin/loginData',data);
                   if(json.return == true) {
                       location.href = '/ad07/admin/slideList';
                   }
                   else {
    ...
    //
		...
		// });
          ...
          //     location.href = '/ad07/admin/estimateView/'+idx;
          // });
